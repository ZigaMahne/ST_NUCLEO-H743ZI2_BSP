...
//  signal,     pin,                   pull resistor,      active state
  ...
  { vioLED2,    GPIO_PIN_ID_PORTE(1),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
